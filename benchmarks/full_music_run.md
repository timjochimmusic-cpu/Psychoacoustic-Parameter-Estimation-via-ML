...
The prepared launcher requests four CPUs, 64 GiB, and 48 hours, with one full-song
worker and four one-second workers. These are provisional settings pending source
inventory and partition limits. Memory and runtime scaling are not established
