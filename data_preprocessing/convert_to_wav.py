...
if __name__ == "__main__":
    convert_to_wav(
        input_folder= "/Users/hassi/Projects/Psychoacoustic-Parameter-Estimation-via-ML/data/test",
        output_folder= "/Users/hassi/Projects/Psychoacoustic-Parameter-Estimation-via-ML/data/processed",
        segment_length_s= 60
    )
    split_reference_into_training_segments(
    input_folder=Path(
        "/Users/hassi/Projects/Psychoacoustic-Parameter-Estimation-via-ML/"
        "data/processed/1file"
    ),
    output_folder=Path(
        "/Users/hassi/Projects/Psychoacoustic-Parameter-Estimation-via-ML/"
        "data/processed/1s_training"
    ),
)
